 ...
 *
 * As of July 2026 everything runs on gemini-3.1-flash-lite (GA, cost/latency-optimised).
 * The gemini-2.5-* models we were on are being deprecated. Override per-tier via env if you
 * later want to split Flash/Pro workloads (e.g. a heavier model for reasoning).
 */
export const GEMINI_FLASH = process.env.GEMINI_MODEL_FLASH || 'gemini-3.1-flash-lite'
export const GEMINI_PRO   = process.env.GEMINI_MODEL_PRO   || 'gemini-3.1-flash-lite'
